...
const Card = ({ id, imageSrc, onClick, title, active, disabled }: Props) => {
  return (
    <div
      onClick={() => onClick(id)}
      className={cn(
        "h-full border-2 rounded-xl border-b-4 hover:bg-black/5 active:border-b-2 cursor-pointer flex flex-col items-center justify-between p-3 pb-6 min-h-[217px] min-w-[200px]",
